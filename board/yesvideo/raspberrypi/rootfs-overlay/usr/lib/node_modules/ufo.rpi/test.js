...
var laserTestDelay = 4000;
var servoTestDelay = 1000;
...
var tests = [
    ...
    [ledTest(1, 10), ledTestDelay],
    [ledTest(2, 10), ledTestDelay],
    [ledTest(3, 10), ledTestDelay],
    [ledTest(4, 10), ledTestDelay],
    [ledTest(5, 10), ledTestDelay],
    [ledTest(6, 10), ledTestDelay],
    [ledTest(7, 10), ledTestDelay],
    [ledTest(8, 10), ledTestDelay],
